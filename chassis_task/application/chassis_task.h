...
// 低通滤波平滑时间
#define CHASSIS_ACCEL_X_NUM 150.0f
#define CHASSIS_ACCEL_Y_NUM 150.0f
#define CHASSIS_ACCEL_W_NUM 150.0f
...
//底盘任务控制间隔 2ms
#define CHASSIS_CONTROL_TIME_MS 8
...
typedef enum
{
  ...
  CHASSIS_SPIN,       //chassis will have rotation speed control. 底盘小陀螺旋转
  CHASSIS_VECTOR_RAW,                 //control-current will be sent to CAN bus derectly. 底盘下电模式
